...
public class DaoPersona {
	...
	public int crearPersona2(PersonaTo persona){
		...
		try {
			...
			conexionActual.agregarAtributo(1, TextAdmin.parseWIN(persona.getPrimerNombre())); 	
			conexionActual.agregarAtributo(2, TextAdmin.parseWIN(persona.getSegundoNombre())); 
			conexionActual.agregarAtributo(3, TextAdmin.parseWIN(persona.getPrimerApellido())); 
			conexionActual.agregarAtributo(4, TextAdmin.parseWIN(persona.getSegundoApellido())); 
			conexionActual.agregarAtributo(5, persona.getNumeroDocumento());
			conexionActual.agregarAtributo(6,persona.getDireccion());
			conexionActual.agregarAtributo(7, persona.getTelefono());
			conexionActual.agregarAtributo(8, TextAdmin.parseWIN(persona.getCorreo()));
			conexionActual.agregarAtributo(9, persona.getTipoDocumento().getIdTipoDocumento());
			conexionActual.agregarAtributo(10, persona.getEps().getIdEPS());
			conexionActual.agregarAtributo(11, persona.getPerfil().getIdPerfil());
	...
	public boolean actualizarPersonaDetalle(PersonaDetalleTo persona){
		...
		try {
			...
			conexionActual.agregarAtributo(17, TextAdmin.parseWIN(persona.getBarrio()));
			conexionActual.agregarAtributo(18, persona.getEstrato());
			conexionActual.agregarAtributo(19, TextAdmin.parseWIN(persona.getPersonaEmergencia()));
			conexionActual.agregarAtributo(20, persona.getTelefonoEmergencia());
			conexionActual.agregarAtributo(21, TextAdmin.parseWIN(persona.getParentescoEmergencia()));
			conexionActual.agregarAtributo(22, persona.getFormatoSolicitud());
			conexionActual.agregarAtributo(23, TextAdmin.parseWIN(persona.getInstitucionRemision()));
			conexionActual.agregarAtributo(24, TextAdmin.parseWIN(persona.getParentescoAcudiente()));
			conexionActual.agregarAtributo(25, persona.getTelefonoAcudiente());
			conexionActual.agregarAtributo(26, TextAdmin.parseWIN(persona.getPersonasReside()));
