--------------------------------------------------------
-- Archivo creado  - miércoles-febrero-22-2017   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table CITA
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CPCDB"."CITA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CPCDB"."TRATAMIENTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into CPCDB.CITA (ID_CITA,SALON,FECHA_SOLICITUD,FECHA_CITA,ID_PRACTICANTE,ID_PACIENTE,ESTADO,ID_TRATAMIENTO,ID_REPORTE,ES_VALORACION,NUM_CITA) values ('21','100',to_timestamp('22/02/17 12:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),to_timestamp('20/02/17 06:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),'141','161','creada','21','0','1','0');
...
SET DEFINE OFF;
Insert into CPCDB.TRATAMIENTO (ID_TRATAMIENTO,ID_PACIENTE,ESTADO,FECHA_INICIO,FECHA_CIERRE,TIPO,NUM_CITA_ACTUAL) values ('21','161','valoracion',to_timestamp('20/02/17 06:00:00,000000000 AM','DD/MM/RR HH12:MI:SSXFF AM'),null,'individual','0');
--------------------------------------------------------
