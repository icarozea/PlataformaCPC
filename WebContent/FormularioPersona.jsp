...
<body onload="cargueInicial()">
	...
	<div id="formularioIngreso">
		...
		<form align="center" id="formCreatePersona" name="formCreatePersona"
			value="formCreatePersona" action="./ServletPersona" method="POST">
			<input type="hidden" name="operacion" id="operacion" /> <input
				type="hidden" name="superior" id="superior"
				value="${requestScope.sup}" /> <input type="hidden" name="id"
				id="id" value="${requestScope.idPersona}" />
			<table id="tablaFormulario" class="tablaPrincipal">
					...
					<td><c:choose>
							<c:when test="${requestScope.pNom != null}">
								<input type="text" id="nombre1" name="nombre1"
									placeholder="Primer Nombre" value="${requestScope.pNom}"
									required></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="nombre1" name="nombre1"
					...
					<td><c:choose>
							<c:when test="${requestScope.sNom != null}">
								<input type="text" id="nombre2" name="nombre2"
									placeholder="Segundo Nombre" value="${requestScope.sNom}"></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="nombre2" name="nombre2"
					...
					<td><c:choose>
							<c:when test="${requestScope.pApe != null}">
								<input type="text" id="apellido1" name="apellido1"
									placeholder="Primer Apellido" value="${requestScope.pApe}"
									required></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="apellido1" name="apellido1"
					...
					<td><c:choose>
							<c:when test="${requestScope.sApe != null}">
								<input type="text" id="apellido2" name="apellido2"
									placeholder="Segundo Apellido" value="${requestScope.sApe}"></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="apellido2" name="apellido2"
					...
					<td><c:choose>
							<c:when test="${requestScope.num != null}">
								<input type="text" id="numeroDocumento" name="numeroDocumento"
									placeholder="Numero Documento" value="${requestScope.num}"></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="numeroDocumento" name="numeroDocumento"
					...
					<td><c:choose>
							<c:when test="${requestScope.tel != null}">
								<input type="text" id="telefono" name="telefono"
									placeholder="Teléfono" value="${requestScope.tel}" required=""></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="telefono" name="telefono"
					...
					<td><c:choose>
							<c:when test="${requestScope.tel2 != null}">
								<input type="text" id="telefono2" name="telefono2"
									placeholder="Otro Teléfono" value="${requestScope.tel2}"></td>
					</c:when>
					<c:otherwise>
						<input type="text" id="telefono2" name="telefono2"
					...
					<td><c:choose>
							<c:when test="${requestScope.pass != null}">
								<input type="password" id="password" name="password"
									value="${requestScope.pass}" required=""></td>
					</c:when>
					<c:otherwise>
				...
				<tr>
					...
					<td><select id="perfil" name="perfil"
						onchange="mostrarEPS(this.value)">
							<option value="-1">Seleccione</option>
				...
				<td><c:choose><c:when test="${requestScope.perfil == 3}">
					...
					<c:choose>
						<c:when test="${requestScope.cod != null}">
							<input type="text" id="codigo" name="codigo" value="${requestScope.cod}" required="" style="display: none;">
						</c:when>
						<c:otherwise>
							<input type="text" id="codigo" name="codigo" required="" style="display: none;">
						</c:otherwise>
					</c:choose>
				...
				<tr>
					...
					<td><c:choose>
						...
						<option value="-1">Seleccione</option> <c:forEach
							items="${listaEPS}" var="varEPS">
							<c:choose>
				...
				<tr>
					<c:choose>
						...
						<c:otherwise>
							<td id="seccionJornada" style="display: none;">Jornada:</td>
						</c:otherwise>
					</c:choose>
					<td><c:choose>
							<c:when test="${requestScope.perfil == 4 || requestScope.perfil == 3}">
							...
							<c:otherwise>
								<select id="jornada" name="jornada" style="display: none;">
							</c:otherwise>
						</c:choose>
						<c:choose>
