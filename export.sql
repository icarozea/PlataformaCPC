--------------------------------------------------------
-- Archivo creado  - viernes-febrero-24-2017   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CPCDB"."CITA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CPCDB"."REPORTE_SESION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "CPCDB"."TRATAMIENTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into CPCDB.PERSONA (ID_PERSONA,PRIMER_NOMBRE,SEGUNDO_NOMBRE,PRIMER_APELLIDO,SEGUNDO_APELLIDO,NUMERO_DOCUMENTO,DIRECCION,TELEFONO,TIPO_DOCUMENTO_ID_DOCUMENTO,EPS_ID_EPS,PERSONA_ID_SUPERIOR,PERFIL_ID_PERFIL,PERSONA_ID_PERSONA,USUARIO,PASS,CORREO,OTRO_TEL,CODIGO,JORNADA) values ('183','Miguel','Andres','Rincon','D?az','999','Calle falsa 789','7777777','1','0','0','3',null,null,'123','michel@localhost.com','3109999999','506888777','tarde');
REM INSERTING into CPCDB.REPORTE_SESION
SET DEFINE OFF;
Insert into CPCDB.REPORTE_SESION (ID_SESION,FECHA,NOMBRE_PROFESIONAL,OBJETIVO_SESION,DESCRIPCION_SESION,TAREAS_ASIGNADAS,ACTIVIDADES_PROX_SESION,RECIBO,ES_FALLO) values ('101',to_timestamp('24/02/17 12:06:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Miguel Andres Rincon D�az','sdgsdfgd','dfgdfg','dfgdfgdf','dfgdfgdf','2','0');
Insert into CPCDB.REPORTE_SESION (ID_SESION,FECHA,NOMBRE_PROFESIONAL,OBJETIVO_SESION,DESCRIPCION_SESION,TAREAS_ASIGNADAS,ACTIVIDADES_PROX_SESION,RECIBO,ES_FALLO) values ('86',to_timestamp('23/02/17 01:57:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'yo','vgdffd','dfgbdfghdf','dfgdf','dfgfd','1','0');
Insert into CPCDB.REPORTE_SESION (ID_SESION,FECHA,NOMBRE_PROFESIONAL,OBJETIVO_SESION,DESCRIPCION_SESION,TAREAS_ASIGNADAS,ACTIVIDADES_PROX_SESION,RECIBO,ES_FALLO) values ('102',to_timestamp('24/02/17 12:08:00,000000000 PM','DD/MM/RR HH12:MI:SSXFF AM'),'Miguel Andres Rincon D�az',null,null,null,null,'3','1');
